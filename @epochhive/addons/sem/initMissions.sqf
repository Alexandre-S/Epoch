...
SEM_MinPlayerDynamic = 3; 	// Minimum number of online players for additional/parallel running missions.
SEM_MissionTimerMin = 20;	// Minimum minutes between missions.
SEM_MissionTimerMax = 35;	// Maximum minutes between missions.
SEM_MissionCleanup = 30;	// Minutes after a mission finished where all mission objects (including AI) will be deleted (0 or -1 equals never).
...
_dynamicMissionsPath = "sem\missions\";
_dynamicMissions = [
	["supplyVanCrash",	"Supply Van",		45,	100],
	["bPlaneCrash",		"Plane Crashsite",	45,	90],
	["bHeliCrash",		"Heli Crashsite",	45,	85],
