...
OTHER PLAYERS ARE ALLOWED TO GO BACK BUT ONLY REFITTED.<br/>
RETURN IN ZONE AS BAMBI IF ATTACK IS NOT FINISHED IS NOT TOLERATED,<br/>
THEN, IS AT YOUR OWN RISK (BAMBI KILL WILL BE AUTHORIZED IN THIS CASE AND THAT CASE ONLY).<br/>
<br/>
IF PLAYERS OF ATTACKING TEAM ARE ALL DEAD,<br/>
YOU ARE NOT ALLOWED TO GO BACK IN COMBAT ZONE TO RECOVER OUR STUFF OR RESTART THE FIGHT,<br/>
YOUR LOOSE WILL BE GAINS OF WINNERS AND THE FIGHT IS OVER.<br/>
<br/>
IF ATTACKING PLAYERS ARE NOT ALL DEAD,<br/>
OTHER PLAYERS ARE ALLOWED TO GO BACK BUT ONLY REFITTED.<br/>
YOU ARE NOT ALLOWED TO RECOVER OUR STUFF WHEN YOU GO BACK REFITTED IN FIGHT (THIS IS GAINS DURING THE FIGHT),<br/>
UNLESS THAT DEFENDS TEAM ARE FULLY DEAD.<br/>
<br/>
7. YOU MUST WAIT TIME OF REBOOT (4h) BEFORE RENEW A NEW BASE ATTACK AGAINST SAME PLAYERS.<br/>
8. YOU MUST WAIT TIME OF REBOOT (4h) BEFORE COUNTER-ATTACK AGAINST SAME PLAYERS.<br/>
<br/>
FRANCAIS:<br/>
...
LES AUTRES JOUEURS PEUVENT REVENIR MAIS UNIQUEMENT RÉÉQUIPÉ.<br/>
LE RETOUR SUR ZONE EN BAMBI ALORS QUE L’ATTAQUE N’EST PAS TERMINÉE N’EST PAS TOLÉRÉE,<br/>
OU ALORS C’EST À VOS RISQUES ET PÉRILS (LE BAMBI KILL SERA AUTORISÉ DANS CE CAS ET UNIQUEMENT CE CAS).<br/>
<br/>
SI LES JOUEURS DE L’ÉQUIPE QUI ATTAQUENT UNE BASE SONT TOUS MORT,<br/>
ILS N’ONT PAS LE DROIT DE REVENIR SUR ZONE POUR RÉCUPÉRER LEUR STUFF OU REPRENDRE LE COMBAT,<br/>
...
LES AUTRES PEUVENT REVENIR UNIQUEMENT S’ILS SONT RÉÉQUIPÉS.<br/>
VOUS N’AVEZ PAS LE DROIT DE RÉCUPÉRER VOS STUFF UNE FOIS REVENU ÉQUIPÉ (CE SONT LES GAINS EN JEU PENDANT LE COMBAT),<br/>
SAUF SI L’ÉQUIPE QUI DÉFEND EST TOMBÉ ENTIÈREMENT.<br/>
<br/>
7. VOUS DEVEZ LAISSER LE TEMPS D’UN REBOOT (4H) AVANT DE RENOUVELER UNE ATTAQUE DE BASE CONTRE LES MÊMES PERSONNES.<br/>
8. VOUS DEVEZ LAISSER LE TEMPS D’UN REBOOT (4H) AVANT DE CONTRE-ATTAQUER L'ÉQUIPE QUI VOUS À ATTAQUÉ."]];

player createDiaryRecord["rules",["BASES AND BUILDING","<br/>
ENGLISH:<br/>
...
8. YOU MUST HAVE A DOOR, NO WALLS AS DOORS<br/><br/>
FRANCAIS:<br/>
