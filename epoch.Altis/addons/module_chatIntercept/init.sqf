[] call compile preProcessFilelineNumbers "addons\module_chatIntercept\config.sqf";
[] call compile preProcessFilelineNumbers "addons\module_chatIntercept\commands.sqf";

pvpfw_chatIntercept_executeCommand = compile preProcessFilelineNumbers "addons\module_chatIntercept\executeCommand.sqf";
